      ...
      const fetchUserType = async () => {
        try {
          ...
          if (response.ok) {
            ...
            console.log("line 27",data.userType);
          } else {
    ...
    const getuserDetails = async (user_id) => {
      try {
        ...
        if (data.type==="student") {
          ...
          setPhone(data.phone || "");
          setRoom(data.studentDetails.room || "");
...
<a class=" relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-blue-500 rounded-md group-hover:bg-opacity-0" href="/dashboard">
Back
</a>
</button>
